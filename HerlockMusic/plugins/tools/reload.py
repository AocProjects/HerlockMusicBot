...
from HerlockMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from HerlockMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Herlock.stop_stream(message.chat.id)
    except:
        pass
