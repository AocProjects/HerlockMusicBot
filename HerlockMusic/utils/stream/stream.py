...
from HerlockMusic.utils.exceptions import AssistantErr
from HerlockMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from HerlockMusic.utils.inline.playlist import close_markup
from HerlockMusic.utils.pastebin import Herlockbin
from HerlockMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Herlock.force_stop_stream(chat_id)
